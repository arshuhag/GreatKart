...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            #messages.success(request, 'Thank you for registering! We have sent you an activation email. Please check your inbox and click on the link to activate your account.')
...
def login(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            url = request.META.get('HTTP_REFERER') #get the url of the page where the user is coming from
            #redirect the user to the page where they are coming from
            try:
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                user.save()
                # auth.logout(request) #logout the user after changing the password
